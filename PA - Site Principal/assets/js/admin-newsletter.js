(function () {
    ...
    function bindToolbar() {
        ...
        const senderFilter = document.getElementById('newsletter-sender-filter');
    ...
    function renderNewsletters(newsletters, append) {
        ...
        const html = newsletters.map(nl => {
            ...
            const senderLabel = escapeHtml(nl.created_by_user_type_label || 'Unknown sender');
            return `
        ...
        <div class="admin-list-item-header">
            <div>
                ...
                <p style="font-size:14px;color:#9ca3af;margin:4px 0 0 0;">
                    ...
                    <span class="status-badge" style="margin-left:6px;background:#e2e8f0;color:#334155;">${senderLabel}</span>
