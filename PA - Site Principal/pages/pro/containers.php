...
<div class="container">
    <div class="offers-toolbar" style="margin-bottom:16px;">
        <div class="offers-toolbar-filters" style="gap:10px;flex-wrap:wrap;">
            <input id="container-search" type="search" placeholder="Search by container name..." data-i18n-placeholder="pro.containers.search_placeholder" autocomplete="off" />

            <select id="container-sort" style="min-width:170px;">
                <option value="created_desc" data-i18n="pro.containers.sort_newest">Newest</option>
                <option value="created_asc" data-i18n="pro.containers.sort_oldest">Oldest</option>
                <option value="name_asc" data-i18n="pro.containers.sort_name_asc">Name A → Z</option>
                <option value="name_desc" data-i18n="pro.containers.sort_name_desc">Name Z → A</option>
            </select>

            <button id="container-nearest-btn" class="btn-secondary" type="button" style="min-width:160px;"><span data-i18n="pro.containers.nearest_to_me">Nearest to me</span></button>

            <select id="container-page-size" style="min-width:130px;">
                <option value="4" data-i18n="pro.containers.per_page_4">4 / page</option>
                <option value="8" data-i18n="pro.containers.per_page_8">8 / page</option>
                <option value="12" data-i18n="pro.containers.per_page_12">12 / page</option>
                <option value="20" data-i18n="pro.containers.per_page_20">20 / page</option>
                <option value="50" data-i18n="pro.containers.per_page_50">50 / page</option>
            </select>
        </div>
        <div class="offers-toolbar-search" style="margin-top:10px;">
            <button id="container-reset-filters" class="btn-secondary" type="button"><i class="fa-solid fa-rotate-right" aria-hidden="true"></i> <span data-i18n="pro.containers.reset_filters">Reset filters</span></button>
        </div>
    </div>
...
<div class="add-modal" id="container-items-modal" role="dialog" aria-hidden="true" aria-labelledby="container-items-title">
    <div class="add-modal-content" style="max-width:760px;width:95%;">
        ...
        <h2 id="container-items-title"><i class="fa-solid fa-boxes" style="margin-right:10px;"></i><span id="container-items-container-name" data-i18n="pro.containers.items">Items</span></h2>
        ...
        <div id="container-items-empty" style="display:none;color:#6b7280;text-align:center;padding:10px;font-size:.95rem;" data-i18n="pro.containers.no_items">No approved items in this container.</div>
        <div style="margin-top:16px;display:flex;justify-content:flex-end;"><button class="btn-secondary" id="container-items-close-btn" data-i18n="pro.containers.close">Close</button></div>
    </div>
</div>
...
<div class="add-modal" id="container-item-detail-modal" role="dialog" aria-hidden="true" aria-labelledby="item-detail-title" style="z-index:12000;">
    <div class="add-modal-content" style="max-width:820px;width:98%;">
        ...
        <div id="item-detail-files" style="margin-top:14px;background:#fff;border:1px solid #e5e7eb;border-radius:10px;padding:12px;">
            <h4 style="margin:0 0 8px;" data-i18n="pro.containers.attachments">Attachment(s)</h4>
        ...
        <div style="margin-top:16px;display:flex;justify-content:space-between;align-items:center;gap:10px;flex-wrap:wrap;">
            <button id="item-download-zip" class="btn-primary" type="button" style="min-width:170px;"><i class="fa-solid fa-file-zipper" style="margin-right:6px;"></i><span data-i18n="pro.containers.download_zip">Download ZIP</span></button>
            <div style="margin-left:auto;display:flex;gap:8px;flex-wrap:wrap;">
                <button id="item-mark-recovered" class="btn-secondary" type="button"><i class="fa-solid fa-rotate-right" style="margin-right:6px;"></i><span data-i18n="pro.containers.mark_as_recovered">Mark as Recovered</span></button>
                <button class="btn-secondary" id="item-detail-close-btn"><i class="fa-solid fa-times" style="margin-right:6px;"></i><span data-i18n="pro.containers.close">Close</span></button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="add-modal-content">
        ...
        <div style="display:flex;flex-direction:column;gap:14px;margin-top:8px;">
            <div style="display:flex;align-items:flex-start;gap:12px;">
                ...
                <div>
                    <div style="font-weight:600;color:#111827;" data-i18n="pro.containers.full_address">Full address</div>
            ...
            <div style="display:flex;align-items:flex-start;gap:12px;">
                ...
                <div>
                    <div style="font-weight:600;color:#111827;" data-i18n="pro.containers.city">City</div>
            ...
            <div style="display:flex;align-items:flex-start;gap:12px;">
                ...
                <div>
                    <div style="font-weight:600;color:#111827;" data-i18n="pro.containers.postal_code">Postal code</div>
            ...
            <div style="display:flex;align-items:flex-start;gap:12px;">
                ...
                <div>
                    <div style="font-weight:600;color:#111827;" data-i18n="pro.containers.added_on">Added on</div>
        ...
        <div id="container-modal-map" style="height:260px;border-radius:10px;overflow:hidden;margin-top:18px;background:#f3f4f6;display:flex;align-items:center;justify-content:center;">
            <span style="color:#9ca3af;font-size:.9rem;"><i class="fa-solid fa-map-location-dot"></i> <span data-i18n="pro.containers.loading_map">Loading map…</span></span>
        </div>
        <div style="margin-top:16px;display:flex;justify-content:flex-end;"><button class="btn-secondary" id="container-modal-close-btn" data-i18n="pro.containers.close">Close</button></div>
    </div>
</div>
...
<div class="add-modal" id="container-confirm-action-modal" style="z-index:13000;" role="dialog" aria-hidden="true" aria-labelledby="container-confirm-action-title">
    <div class="add-modal-content" style="max-width:520px;width:95%;padding:16px;">
        ...
        <h2 id="container-confirm-action-title"><i class="fa-solid fa-circle-exclamation" style="margin-right:8px;"></i><span data-i18n="pro.containers.confirm_action_title">Confirm action</span></h2>
        ...
        <div id="container-confirm-action-actions" style="display:flex;justify-content:flex-end;gap:8px;margin-top:12px;">
            <button class="btn-secondary" id="container-confirm-action-cancel" type="button"><i class="fa-solid fa-xmark" style="margin-right:6px;"></i><span data-i18n="pro.containers.cancel">Cancel</span></button>
            <button class="btn-primary" id="container-confirm-action-confirm" type="button"><i class="fa-solid fa-check" style="margin-right:6px;"></i><span data-i18n="pro.containers.confirm">Confirm</span></button>
        </div>
    </div>
</div>
