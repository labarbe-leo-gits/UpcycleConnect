...
switch ($user['user_type']) {
	...
	case 2:
		if (!$user['is_premium']) {
			$_SESSION['flash_message'] = 'Access to the planning feature is reserved for Pro users. Please upgrade your account to access this feature.';
			header('Location: ../pro/profile');
			exit;
		}
		include '../../includes/pro-header.php';
		break;
	case 4:
