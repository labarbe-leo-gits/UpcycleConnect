...
func main() {
	...
	registerRoute("GET", "/internal/contracts", "Get all contracts with user details for internal admin use", app.GetAllContracts, InternalKeyMiddleware)
	registerRoute("GET", "/internal/contracts/{id}", "Get a contract by its UUID for internal admin use", app.GetContractByID, InternalKeyMiddleware)
	...
	*/
	...
	registerRoute("GET", "/newsletters", "Get paginated newsletters with search and filtering (admin only)", app.GetNewsletters, app.JWTAuthMiddleware)
	registerRoute("GET", "/newsletters/{id}", "Get full newsletter details (admin only)", app.GetNewsletter, app.JWTAuthMiddleware)
	registerRoute("GET", "/newsletter-subscribers", "Get newsletter subscriber list (admin only)", app.GetNewsletterSubscribers, app.JWTAuthMiddleware)
	registerRoute("POST", "/newsletters", "Create a new draft newsletter (admin only)", app.CreateNewsletter, app.JWTAuthMiddleware)
	registerRoute("PATCH", "/newsletters/{id}", "Update an existing newsletter (admin only)", app.UpdateNewsletter, app.JWTAuthMiddleware)
	registerRoute("PATCH", "/newsletter/{id}/status", "Update the status of an existing newsletter (admin only)", app.UpdateNewsletterStatus, app.JWTAuthMiddleware)
	...
	registerRoute("DELETE", "/revenue-report", "Delete a specific revenue report by ID", app.DeleteRevenueReport, app.JWTAuthMiddleware, RoleMiddleware(3))
